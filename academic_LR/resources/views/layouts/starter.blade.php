            ...
            <div class="col-md-4 stretch-card grid-margin">
              <div class="row">
                <div class="col-md-12 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      <p class="card-title">Total Surat</p>
                      <div class="charts-data">
                        @if(Auth::user()->userRole->id == 2)
                          {{-- In Progress --}}
                          <div class="mt-3">
                            <p class="mb-0">In Progress</p>
                              ...
                              @foreach($pengajuans as $pengajuan)
                                ...
                                @endif
                              @endforeach
                            @php($width1 = $no1 * 100 / $nototal1)
                            <div class="d-flex justify-content-between align-items-center">
                              <div class="progress progress-md flex-grow-1 mr-4">
                                <div class="progress-bar bg-inf0" role="progressbar" style="width: {{ $width1 }}%" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100"></div>
                              </div>
                              <p class="mb-0">
                                {{ $no1 }}
                              </p>
                          ...
                          <div class="mt-3">
                            <p class="mb-0">Accepted</p>
                              ...
                              @foreach($pengajuans as $pengajuan)
                                ...
                                @endif
                              @endforeach
                            @php($width2 = $no2 * 100 / $nototal2)
                            <div class="d-flex justify-content-between align-items-center">
                              <div class="progress progress-md flex-grow-1 mr-4">
                                <div class="progress-bar bg-inf0" role="progressbar" style="width: {{ $width2 }}%" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100"></div>
                              </div>
                              <p class="mb-0">
                                {{ $no2 }}
                              </p>
                          ...
                          <div class="mt-3">
                            <p class="mb-0">Rejected</p>
                              ...
                              @foreach($pengajuans as $pengajuan)
                                ...
                                @endif
                              @endforeach
                            @php($width3 = $no3 * 100 / $nototal3)
                            <div class="d-flex justify-content-between align-items-center">
                              <div class="progress progress-md flex-grow-1 mr-4">
                                <div class="progress-bar bg-inf0" role="progressbar" style="width: {{ $width3 }}%" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100"></div>
                              </div>
                              <p class="mb-0">
                                {{ $no3 }}
                              </p>
                          ...
                          <div class="mt-3">
                            <p class="mb-0">Finished</p>
                              ...
                              @foreach($pengajuans as $pengajuan)
                                ...
                                @endif
                              @endforeach
                            @php($width4 = $no4 * 100 / $nototal4)
                            <div class="d-flex justify-content-between align-items-center">
                              <div class="progress progress-md flex-grow-1 mr-4">
                                <div class="progress-bar bg-inf0" role="progressbar" style="width: {{ $width4 }}%" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100"></div>
                              </div>
                              <p class="mb-0">
                                {{ $no4 }}
                              </p>
